...
let modelSwitch = document.getElementById("model-button");
modelSwitch.addEventListener("click", changeModel);
...
function changeDuration() {
    ...
    let newDuration = prompt("How many days would you like to  rent the vehicle?");
    if (newDuration !==null) {
